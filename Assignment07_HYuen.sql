...
-- 2023-05-30,Herman Yuen,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_HYuen')
	 Begin 
	  Alter Database [Assignment07DB_HYuen] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_HYuen;
	 End
	Create Database Assignment07DB_HYuen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_HYuen;
...
-- <Put Your Code Here> --
Select
	C.CategoryName, P.ProductName, UnitPrice = Format(P.UnitPrice, 'C', 'en-us')
